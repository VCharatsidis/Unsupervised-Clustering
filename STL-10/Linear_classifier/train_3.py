...
def encode_4_patches(image, encoder):
    ...
    crop_bin = center_crop(image, SIZE, BATCH_SIZE_DEFAULT)
    ...
    augments = {0: original_hfliped,
                ...
                23: random_crop(horiz_f, SIZE, BATCH_SIZE_DEFAULT),
                24: random_crop(horiz_f, SIZE, BATCH_SIZE_DEFAULT),
                25: random_crop(horiz_f, SIZE, BATCH_SIZE_DEFAULT),
                26: original_image
                }
