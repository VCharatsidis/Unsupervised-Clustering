...
def encode_images(image, encoder):
    number_augments = 15
    ids = np.random.choice(number_augments, size=2, replace=False)
    ...
    return test_preds_1, test_preds_2,\
           help_preds_1_1, help_preds_2_1,\
           help_preds_1_2, help_preds_2_2,\
           help_preds_1_3, help_preds_2_3,\
           help_preds_1_4, help_preds_2_4,\
           image, ids
...
def forward_block(X, ids, encoder, optimizer, train, total_mean):
    ...
    test_preds_1, test_preds_2, \
    help_preds_1_1, help_preds_2_1, \
    help_preds_1_2, help_preds_2_2, \
    help_preds_1_3, help_preds_2_3, \
    help_preds_1_4, help_preds_2_4, \
    orig_image, aug_ids = encode_images(images, encoder)
