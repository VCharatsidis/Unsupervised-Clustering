...
class ConvLayer(nn.Module):
    def __init__(self, in_channels=1):
        ...
        self.conv = nn.Sequential(
            nn.Conv2d(in_channels, 128, kernel_size=3, stride=1, padding=0),
            nn.ReLU(),
...
class DigitCaps(nn.Module):
    ...
    def __init__(self, num_capsules=10, num_routes=16 * 4 * 4, in_channels=8, out_channels=16):
